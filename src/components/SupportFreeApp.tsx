      ...
      <div className="rounded-2xl border border-gray-200/80 bg-white/70 px-4 py-3 text-sm shadow-sm backdrop-blur">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-xs leading-relaxed text-black-500">
            ...
            <strong>Did you find this helpful?</strong> You're welcome to support the guide, but it's completely optional. Your support helps keep it free for students, residents, and visitors. Thank you.
          </p>
